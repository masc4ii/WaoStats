...
namespace team{
    ...
    public:
        ...
        const std::list <MemberLinkedApps>& apps()const{return m_apps;};
            ...
            /**
                ...
                :meth:`linked_apps_list_members_linked_apps` to retrieve the
                rest.
            */
    ...
    public:
        ...
        class factory{
        public:
            static std::unique_ptr<ListMembersAppsResult>  create(const QByteArray& data);
            static std::unique_ptr<ListMembersAppsResult>  create(const QJsonObject& js);
        };
