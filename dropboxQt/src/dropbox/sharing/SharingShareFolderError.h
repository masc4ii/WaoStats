...
namespace sharing{
    ...
    public:
        ...
        ShareFolderError_NO_PERMISSION
        };
    ...
    public:
        ...
        class factory{
        public:
            static std::unique_ptr<ShareFolderError>  create(const QByteArray& data);
            static std::unique_ptr<ShareFolderError>  create(const QJsonObject& js);
        };
