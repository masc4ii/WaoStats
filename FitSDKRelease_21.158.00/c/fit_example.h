...
#define FIT_SESSION_MESG_SIZE                                                   278
...
#define FIT_RECORD_MESG_SIZE                                                    100
#define FIT_RECORD_MESG_DEF_SIZE                                                152
...
typedef struct
{
   ...
   FIT_UINT8 battery_soc; // 2 * percent + 0, lev battery state of charge
} FIT_RECORD_MESG;
...
typedef struct
{
   ...
   FIT_UINT16 timestamp_ms; // 1 * ms + 0, Fractional part of timestamp, added to timestamp
   FIT_SINT16 pitch[FIT_AVIATION_ATTITUDE_MESG_PITCH_COUNT]; // 1043038 * radians + 0, Range -PI/2 to +PI/2
   FIT_SINT16 roll[FIT_AVIATION_ATTITUDE_MESG_ROLL_COUNT]; // 1043038 * radians + 0, Range -PI to +PI
   ...
   FIT_UINT16 track[FIT_AVIATION_ATTITUDE_MESG_TRACK_COUNT]; // 1043038 * radians + 0, Track Angle/Heading Range 0 - 2pi
...
#define FIT_WORKOUT_MESG_SIZE                                                   77
