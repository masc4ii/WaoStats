...
namespace qmapcontrol
{
    ...
    MapAdapterKomoot::MapAdapterKomoot(QObject* parent)
        ...
        : MapAdapterTile(QUrl("https://a.tile.hosted.thunderforest.com/komoot-2/%zoom/%x/%y.png"), supportedProjections(), 0, 17, 0, false, parent) /// @todo remove once MSVC supports initializer lists.
    {
