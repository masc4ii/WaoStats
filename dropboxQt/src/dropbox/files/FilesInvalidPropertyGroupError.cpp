...
InvalidPropertyGroupError::operator QJsonObject()const{
    QJsonObject js;
    this->toJson(js, "");
    return js;
}
...
void InvalidPropertyGroupError::toJson(QJsonObject& js, QString name)const{
...
void InvalidPropertyGroupError::fromJson(const QJsonObject& js){
...
QString InvalidPropertyGroupError::toString(bool multiline)const
{
    QJsonObject js;
    toJson(js, "InvalidPropertyGroupError");
