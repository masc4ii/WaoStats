...
std::unique_ptr<ListTeamAppsResult>  ListTeamAppsResult::factory::create(const QByteArray& data)
{
...
std::unique_ptr<ListTeamAppsResult>  ListTeamAppsResult::factory::create(const QJsonObject& js)
{
    std::unique_ptr<ListTeamAppsResult> rv;
    rv = std::unique_ptr<ListTeamAppsResult>(new ListTeamAppsResult);
    rv->fromJson(js);
    return rv;
}
